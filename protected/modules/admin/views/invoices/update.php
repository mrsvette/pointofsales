		...
		<div class="panel-body">
			...
			<div class="tab-content row">
				<div id="detail-invoice" class="tab-pane active">
					<div class="table-responsive col-sm-9 no-padding">
					<?php
					$this->widget('zii.widgets.CDetailView', array(
						...
						'attributes'=>array(
							...
							array(
								'name'=>'status',
								'type'=>'raw',
								'value'=>Lookup::item('InvoiceStatus',$model->status),
							),
							array(
								'name'=>'Customer',
								'type'=>'raw',
				...
				<div id="update-invoice" class="tab-pane">
					...
					<div class="form-group col-sm-4">
						...
						<?php echo $form->dropDownList($model,'status',Lookup::items('InvoiceStatus'),array('class'=>'form-control')); ?>
					</div>
							...
							'buttons'=>array
								(
									'delete'=>array(
											...
											'imageUrl'=>false,
											'url'=>'Yii::app()->createUrl(\'admin/invoices/deleteItem\',array(\'id\'=>$data->id))',
									...
									'add'=>array(
											...
											'imageUrl'=>false,
											'url'=>'Yii::app()->createUrl(\'admin/invoices/addItems\',array(\'id\'=>$data->invoice_id))',
			...
			<div class="table-responsive">
					<?php if($model->items_count>0):?>
						...
						<?php foreach($model->items_rel as $item):?>
							<tr>
								<td><?php echo $no;?></td>	
								<td><?php echo CHtml::link($item->title,array('/admin/orders/update','id'=>$item->rel_id));?></td>	
...
<div id="myModal" class="modal fade" aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="div-for-preview"> Content goes here... </div>
...
$('#btn-delete').click(function(){
	...
	if(confirm('Anda yakin ingin menghapus invoice ini ?')){
		$.ajax({
			...
			'dataType':'json',
			'success':function(data){
				window.location.href="<?php echo Yii::app()->createUrl('/admin/invoices/view');?>";
			}
		});
	}
	return false;
