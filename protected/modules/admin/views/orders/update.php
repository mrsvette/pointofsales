...
$this->menu=array(
	array('label'=>Yii::t('global','List').' Order', 'url'=>array('view')),
	array('label'=>Yii::t('global','Create').' Order', 'url'=>array('create')),
);
?>
		...
		<div class="tab-content">
				...
				$this->widget('zii.widgets.CDetailView', array(
					...
					'attributes'=>array(
						...
						array(
							'name'=>'type',
							'type'=>'raw',
							'value'=>Lookup::item('OrderType',$model->type),
						),
						array(
							'name'=>'status',
							'type'=>'raw',
			...
			<div id="update-order" class="tab-pane">
				...
				<div class="form-group col-sm-4">
					...
					<?php echo $form->dropDownList($model,'status',Lookup::items('OrderStatus'),array('class'=>'form-control')); ?>
				</div>
				...
				$this->widget('zii.widgets.CDetailView', array(
					...
					'attributes'=>array(
						array(
							'name'=>'serie',
							'type'=>'raw',
							'value'=>CHtml::link($model->invoice_rel->invoiceFormatedNumber,array('/admin/invoices/update','id'=>$model->invoice_id)),
						),
						array(
							'name'=>'Total',
							'type'=>'raw',
						...
						array(
							'name'=>'status',
							'type'=>'raw',
							'value'=>Lookup::item('InvoiceStatus',$model->invoice_rel->status),
						),
						array(
							'name'=>'Customer',
							'type'=>'raw',
