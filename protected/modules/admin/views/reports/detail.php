			...
			<?php $this->widget('zii.widgets.grid.CGridView', array(
					...
					'columns'=>array(
						...
						array(
							...
							'type'=>'raw',
							'value'=>'Order::getCountOrderItemDate($_GET[\'date\'],$data->product_id,1)',
							'htmlOptions'=>array('style'=>'text-align:center;'),
						),
						array(
							'header'=>Yii::t('order','Jml Item Malam'),
							'type'=>'raw',
							'value'=>'Order::getCountOrderItemDate($_GET[\'date\'],$data->product_id,2)',
							'htmlOptions'=>array('style'=>'text-align:center;'),
						),
						array(
						...
						array(
							...
							'type'=>'raw',
							'value'=>'number_format(Order::getTotalOrderDate($_GET[\'date\'],$data->product_id,1),0,\',\',\'.\')',
							'htmlOptions'=>array('style'=>'text-align:right;'),
						),
						array(
							'header'=>Yii::t('order','Jml Pendapatan Malam'),
							'type'=>'raw',
							'value'=>'number_format(Order::getTotalOrderDate($_GET[\'date\'],$data->product_id,2),0,\',\',\'.\')',
							'htmlOptions'=>array('style'=>'text-align:right;'),
						),
						array(
...
$(function(){
	...
	$('#order-grid').find('tbody').append('<tr><td colspan="8">TOTAL</td><td style="text-align:right;"><b>'+total+'</b></td></tr>');
});
</script>
