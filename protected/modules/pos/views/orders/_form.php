	...
	<div class="col-sm-9">
		...
		<div class="row">
			<div class="table-responsive mar_top1 col-md-12 col-sm-12" id="sales-frame">
				<table class="table table-striped mb30 items">
					...
					<tr>
						...
						<th><?php echo Yii::t('order','Discount');?></th>
						<th>Total</th>
						<th>&nbsp;</th>
					</tr>
					</thead>
			...
			<div class="col-md-6 col-sm-12 text-right" id="payment-button" style="display:<?php echo (Yii::app()->user->hasState('items_belanja') && count(Yii::app()->user->getState('items_belanja'))>0)? 'block':'none';?>">
				<?php echo CHtml::button(Yii::t('order','Payment'),array('onclick'=>'payRequest("'.Yii::app()->createUrl(Yii::app()->controller->module->id.'/orders/paymentRequest').'");','style'=>'min-width:100px;','id'=>'payment-btn','class'=>'btn btn-success'));?>
				<?php echo CHtml::button(Yii::t('order','Cancel Transaction'),array('onclick'=>'cancelRequest("'.Yii::app()->createUrl(Yii::app()->controller->module->id.'/orders/cancelTransaction').'");','style'=>'min-width:100px;','id'=>'cancel-btn','class'=>'btn btn-default'));?>
